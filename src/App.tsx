...
export default function App() {
  const { progress, setActiveTab } = useProgress();
  const activeTab: AppTab = progress.activeTab;
  ...
  return (
    <div className="min-h-screen bg-stone-100/70 text-stone-900 flex flex-col font-sans selection:bg-amber-200 selection:text-stone-900">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-3 pb-24 sm:p-6 sm:pb-24 lg:p-8">
      ...
      <footer className="bg-white border-t border-stone-200 py-4 px-6 text-xs text-stone-500 mt-auto">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2 text-center sm:text-left">
          <div className="flex items-center gap-2">
            <span className="font-semibold text-stone-800">OYS Language Pal</span>
            <span>•</span>
